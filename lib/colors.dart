...
const messageColor = Color.fromRGBO(11, 116, 101, 1.0);
const senderMessageColor = Color.fromRGBO(37, 45, 49, 1);
const tabColor = Color(0xFFD14DFF);
...
const backColor = Color.fromARGB(31, 29, 12, 56);
const whiteColor = Color.fromARGB(255, 212, 208, 220);
